...
.Bevor Sie beginnen
Sie sollten die _tar.gz_-Datei von  https://mysupport.netapp.com/site/products/all/details/otv10/downloads-tab["NetApp Support-Website"^] heruntergeladen haben.
