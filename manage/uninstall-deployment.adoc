...
** Informationen zum Verschieben in einen nicht verwalteten Datenspeicher finden Sie unter https://techdocs.broadcom.com/us/en/vmware-cis/vsphere/vsphere/8-0/migrate-a-virtual-machine-with-storage-vmotion.html["Storage vMotion"^]
